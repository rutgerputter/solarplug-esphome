...
WRITE_NUMBERS = {
    ...
    "battery_recharge_voltage": ("battery_recharge_voltage", UNIT_VOLT, DEVICE_CLASS_VOLTAGE, 22.0, 25.5, 0.5),
    "battery_redischarge_voltage": ("battery_redischarge_voltage", UNIT_VOLT, DEVICE_CLASS_VOLTAGE, 24.0, 29.0, 0.5),
